        ...
        <div className="px-3 sm:px-4 md:px-6 py-3 md:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            ...
            <div className="flex items-center justify-center sm:justify-end space-x-2">
              ...
              <Button onClick={saveProject} variant="outline" size="sm" className="text-slate-600 border-slate-300 h-8 w-8 sm:w-auto sm:px-3">
                <Save className="w-4 h-4" />
                <span className="hidden sm:inline ml-1">Save</span>
              </Button>
              <Button onClick={exportCanvas} className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white h-8 w-8 sm:w-auto sm:px-3" size="sm">
